...
<body id="content">
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form class="login mt-4" action="./login.php" method="post">
                        <div class="form-group">
                            <label for="uname">Username</label>
                            <input type="text" name="uname" id="uname" placeholder="Username..." class="login-field form-control">
                        </div>
                        <div class="form-group">
                            <label for="pass">Password</label>
                            <input type="password" name="pass" id="pass" placeholder="Password..." class="login-field form-control">
                        </div>
                    ...
                    <div class="mt-5">
                        <a href="javascript:void()" onclick="signup()">Not have any account? Sign Up Here</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function login(){
            $.ajax({
                type: "POST",
                url: "/Praktikum/minggu8/prak/login.php",
                data: $("#form").serialize(),
        ...
        function signup(){
            $.get("/Praktikum/minggu8/prak/signup.php", function(data) {
                $("#content").html(data);
            });
        }

        function log(){
            $.get("/Praktikum/minggu8/prak/index.php", function(data) {
                $("#content").html(data);
            });
        }
    </script>
